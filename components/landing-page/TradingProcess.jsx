...
const TradingProcess = () => {
  return (
    <section
      id="our-trading-process"
      className="py-10 bg-gray-50/50 px-6 md:px-0"
    >
          ...
          {PROCESS_STEPS.map((step, index) => {
            ...
            return (
              <motion.div
                ...
                className="relative group w-full md:w-[calc(45%-1rem)] lg:w-[calc(30%-1rem)] min-w-75"
              >
                <div className="h-full bg-white p-8 rounded-2xl shadow-md hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border border-gray-100 flex flex-col items-start text-left">
                  ...
                  <div className="w-full flex items-center justify-between mb-8">
                    <div
                      className={`w-14 h-14 ${step.color} rounded-xl flex items-center justify-center shadow-inner transition-transform group-hover:rotate-6`}
                    >
