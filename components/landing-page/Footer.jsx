        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-16 gap-10">
          ...
          <div className="md:w-1/2 w-full max-w-md">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                type="button"
                className="rounded-full px-8 py-3.5 bg-white text-black hover:bg-gray-100 font-semibold cursor-pointer transition-all hover:scale-105 active:scale-95 shadow-lg"
              >
                Subscribe
              </button>
            </div>
