		...
		<section id="market-reach" className="py-10 bg-white px-6 md:px-0">
			<div className="mx-auto text-center max-w-7xl">
				<div className="mb-16">
					...
					>
						Strategically positioned to cater to buyers across major trade hubs and domestic markets.
					</motion.p>
				</div>
				...
				<div className="flex flex-wrap justify-center gap-8 mb-16">
					{GLOBAL_REACH.map((region, index) => {
						...
						return (
							...
							>
								<div className={`relative z-10 ${region.color} border border-black/5 p-5 rounded-3xl flex flex-col items-center justify-center w-full min-h-64 shadow-md hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden`}>
									{/* Background Pattern */}
				...
				>
					...
					<p className="text-gray-600 text-sm font-medium">
						Our logistics partners ensure reliable port-to-port and door-to-door delivery solutions.
					</p>
				</motion.div>
			</div>
		</section>
